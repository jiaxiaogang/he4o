...
-(void) updateIndexDic:(AIFoNodeBase*)absFo indexDic:(NSDictionary*)indexDic {
    ...
    //    1 = 3;
    //} (abs:4104 con:4374)
    //Canset演化> NewHCanset:F4374[M1{↑饿-16},A4359(向92,距11,皮果),A4364(向14,距95,棒),A4370(距23,向87,棒)] toScene:F4104[3棒,3棒,3果,飞↑,3果,吃] 在1帧:A4102
    
    //2. 某餈hSolution激活,打印的是这个 (indexDic内容变长了,成了六条);
    //第8步 H排除FRSTime来不及的:19
    //0. I<F4104 F4374[M1{↑饿-16},A4359(向92,距11,皮果),A4364(向14,距95,棒),A4370(距23,向87,棒)]> {0 = 2;3 = 4;2 = 4;5 = 4;1 = 3;4 = 4;}  (null):(分:0.00)
    //1. I<F4104 F4461[M1{↑饿-16},A4447(向91,距12,皮果),A4451(向17,距85,棒),A4458(距25,向88,棒)]> {0 = 2;3 = 4;2 = 4;5 = 4;1 = 3;4 = 4;}  (null):(分:0.00)
    //1. I<F4104 F4461[M1{↑饿-16},A4447(向91,距12,皮果),A4451(向17,距85,棒),A4458(距25,向88,棒)]> {0 = 2;3 = 4;2 = 4;5 = 4;1 = 3;4 = 4;}  (null):(分:0.00)
    //0. I<F4104 F4374[M1{↑饿-16},A4359(向92,距11,皮果),A4364(向14,距95,棒),A4370(距23,向87,棒)]> {0 = 2;3 = 4;2 = 4;5 = 4;1 = 3;4 = 4;}  (null):(分:0.00)
    //4. I<F4104 F4424[M1{↑饿-16},A4359(向92,距11,皮果),A4364(向14,距95,棒),A4370(距23,向87,棒),A4371(向92,距11,果)]> {0 = 2;3 = 4;2 = 4;5 = 4;1 = 3;4 = 4;}  (null):(分:0.00)
    //=====> 疑点: 此处这么多解,它们的indexDic竟然都一样,为啥?
    
    //3. 所以在迁移后 (indexDic内容也是变长的六条);
    //=============================== 49 TCRefrection反思 ===============================
    //F4374[M1{↑饿-16},A4359(向92,距11,皮果),A4364(向14,距95,棒),A4370(距23,向87,棒)] CUT:2 无效率:0.00
    //反思评价结果:已通过 (解决任务奖励分9.0 Canset风险:0.00 懒分:0.0 = 9.0)
    //第9步 H求解最佳结果:F4374 {}
    //updateIndexDic:{
    //  0 = 2;
    //  3 = 4;
