...
-(void) pushFrameFinish {
    ...
    NSLog(@"aaaaa Canset演化> NewRCanset:%@ toScene:%@",ShortDesc4Node(newRCanset),ShortDesc4Node(matchFo));
    ...
    for (TOFoModel *solutionModel in actionFoModels) {
        ...
        NSLog(@"aaaaa Canset演化> AbsRCanset:%@ toScene:%@",ShortDesc4Node(newRCanset),ShortDesc4Node(pFo));
