...
-(void) pushFrameFinish {
    ...
    NSLog(@"aaaaa Canset演化> NewRCanset:%@ toScene:%@",Fo2FStr(newRCanset),ShortDesc4Node(matchFo));
    ...
    for (TOFoModel *solutionModel in actionFoModels) {
        ...
        NSLog(@"aaaaa Canset演化> AbsRCanset:%@ toScene:%@",Fo2FStr(absCansetFo),ShortDesc4Node(pFo));
