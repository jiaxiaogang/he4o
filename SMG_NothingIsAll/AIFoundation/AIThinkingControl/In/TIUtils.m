...
+(void) recognitionCansetFo:(AIFoNodeBase*)newCanset sceneFo:(AIFoNodeBase*)sceneFo es:(EffectStatus)es{
    ...
    //TODOTOMORROW20230404: 连续多次上飞躲开,竟然测不到此处识别出[棒,上,棒,上],并抽象类似的Canset;
    
    
    //1. 识别到的全是下面这些没营养的单帧canset...
    //Canset识别结果: 5条
    //-->>> F629[A385(高100,皮0,向358)] SP:{0 = S0P5;} EFF:F629:H6N0
    //-->>> F626[A385(高100,皮0,向358)] SP:{0 = S0P12;} EFF:F626:H12N1
    //-->>> F596[A385(高100,皮0,向358)] SP:{0 = S0P21;} EFF:F596:H20N2
    //-->>> F610[A385(高100,皮0,向358)] SP:{0 = S0P19;} EFF:F610:H18N2
    //-->>> F558[A385(高100,皮0,向358)] SP:{0 = S0P46;} EFF:F558:H41N6
    //构建absCanset:F386[A385(高100,皮0,向358)] SP:{0 = S0P238;1 = S58P46;} EFF:F386:H120N0
    //构建absCanset:F386[A385(高100,皮0,向358)] SP:{0 = S0P239;1 = S58P46;} EFF:F386:H121N0
    //构建absCanset:F386[A385(高100,皮0,向358)] SP:{0 = S0P240;1 = S58P46;} EFF:F386:H122N0
    //构建absCanset:F386[A385(高100,皮0,向358)] SP:{0 = S0P241;1 = S58P46;} EFF:F386:H123N0
    //构建absCanset:F386[A385(高100,皮0,向358)] SP:{0 = S0P242;1 = S58P46;} EFF:F386:H124N0
    
    
    //2. 也有一些有营养的如下 (但看起来,大多数是较为具象的sceneFo,有距离限制,或者有方向限制):
    //newCanset:F1423[A1308(飞↑),A1412(高100,皮0,向341,距62),A1308(飞↑),A585(高100,皮0,向343)]
    //sceneFo:F586[A585(高100,皮0,向343)]
    //过滤器: 总4需3 主:0.76 => 剩:3 辅:0.98 => 剩:2
    //Canset识别结果: 2条
    //-->>> F1322[A1308(飞↑),A1311(高100,皮0,距70,向344),A1308(飞↑),A585(高100,皮0,向343)] SP:{0 = S0P3;3 = S0P3;2 = S0P3;1 = S0P3;} EFF:
    //-->>> F1347[A1308(飞↑),A1334(高100,皮0,向350,距124),A1308(飞↑),A585(高100,皮0,向343)] SP:{0 = S0P2;3 = S0P2;2 = S0P2;1 = S0P2;} EFF:
    //构建absCanset:F1349[A1308(飞↑),A585(高100,皮0,向343),A1308(飞↑),A1348()] SP:{0 = S0P7;3 = S0P7;2 = S0P7;1 = S0P7;} EFF:F1349:H8N0
    //构建absCanset:F1349[A1308(飞↑),A585(高100,皮0,向343),A1308(飞↑),A1348()] SP:{0 = S0P8;3 = S0P8;2 = S0P8;1 = S0P8;} EFF:F1349:H9N0
    
    
    //3. 看起来是因为没抽象出足够抽象的木棒: 比如(高,皮),导致识别的不够抽象,所以最后的canset迁移性也就不够...
    //=============================== 5 时序识别 ===============================
    //protoFo:F1419[A1308(飞↑),A1412(高100,皮0,向341,距62),A1308(飞↑),A1417(高100,皮0,向292,距31)]->
    //过滤器: 总8需4 主:0.52 => 剩:4 辅:0.95 => 剩:3
    //时序识别结果 P(3条) R(0条)
    //P强度:(22)    > F769[A768(高100,皮0,距61)]->{-0.45} (SP:{0 = S0P48;1 = S1P19;}) indexDic:{0 = 3;} 匹配度 => 0.87
    //P强度:(116)    > F170[A169(高100,皮0,距70)]->{-1.03} (SP:{0 = S0P758;1 = S13P101;}) indexDic:{0 = 3;} 匹配度 => 0.83
    //P强度:(65)    > F586[A585(高100,皮0,向343)]->{-1.60} (SP:{0 = S0P184;1 = S11P51;}) indexDic:{0 = 3;} 匹配度 => 0.72
    
    
    //4. 当然也有一些较ok的,比如下面的向343,和向5,至少在各方向上有迁移性了;
    //=============================== 1 时序识别 ===============================
    //protoFo:F1409[A1407(高100,皮0,向354,距105)]->
    //过滤器: 总9需5 主:0.58 => 剩:5 辅:0.96 => 剩:4
    //时序识别结果 P(4条) R(0条)
    //P强度:(18)    > F792[A791(高100,皮0,距108)]->{-2.65} (SP:{0 = S0P38;1 = S5P12;}) indexDic:{0 = 0;} 匹配度 => 0.99
    //P强度:(104)    > F386[A385(高100,皮0,向358)]->{-5.07} (SP:{0 = S0P236;1 = S58P45;}) indexDic:{0 = 0;} 匹配度 => 0.98
    //P强度:(63)    > F586[A585(高100,皮0,向343)]->{-1.60} (SP:{0 = S0P182;1 = S11P51;}) indexDic:{0 = 0;} 匹配度 => 0.94
    //P强度:(38)    > F959[A958(高100,皮0,向5)]->{-4.62} (SP:{0 = S0P74;1 = S19P18;}) indexDic:{0 = 0;} 匹配度 => 0.94
