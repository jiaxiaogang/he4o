...
+(TCResult*) hSolution:(HDemandModel*)hDemand{
    ...
    //2. 此处执行Solution其实不是Solution,而是TCScore中调用的实时竞争而已,把日志关掉ok了;
    
    //3. 此处有皮果动机,在 "第8步 H排除FRSTime来不及的:0",但其实它有踢的经验,看下为什么都来不急?
    //--> F8632[M1{↑饿-16},M1{↑饿-16},A8616(向140,距0,果),A3979(吃1),A8624(向334,距0,皮果),踢↑,A8629(向85,距9,皮果)]
    //--> F8638[M1{↑饿-16},M1{↑饿-16},A8616(向140,距0,果),A3979(吃1),A8624(向334,距0,皮果),踢↑,A8629(向85,距9,皮果),A8637(向14,距105,棒)]
