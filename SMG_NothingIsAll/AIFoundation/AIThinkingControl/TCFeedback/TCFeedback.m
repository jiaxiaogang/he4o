        ...
        for (TOFoModel *waitModel in waitModels) {
            ...
            if (sameIden) {
                ...
                if (score < 0) {
                    ...
                    [sceneTo updateOutSPStrong:waitModel.cansetActIndex difStrong:1 type:ATSub sceneFrom:waitModel.sceneFrom cansetFrom:waitModel.cansetFrom debugMode:true];
