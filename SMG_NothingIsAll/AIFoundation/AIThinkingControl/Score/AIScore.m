 ...
 *  @status
 *      2021.11.16: 保持TOAction继续使用,但新的RAction弃用 (参考24127-2-稳定性是x%值,所以它不能因为有一条空S就否掉);
 *  @todo
 *      2021.01.29: FRS.SP评价受基conFo.mv影响迭代 (参考22013);
 *      2021.04.23: 空S要考虑使用可行率对ports排名,而不是一棍子打死,终身牛逼,失误一次,打入地狱,太误杀 (参考22014) T;
 ...
 *      2021.11.28: 此处在新螺旋架构中弃用,因为有了新的综合评价 (参考24195);
 */
