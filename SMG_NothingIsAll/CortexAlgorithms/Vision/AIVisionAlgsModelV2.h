...
@property (strong,nonatomic) NSDictionary *splitHColors;//色相
@property (strong,nonatomic) NSDictionary *splitSColors;//饱和度
@property (strong,nonatomic) NSDictionary *splitBColors;//亮度
