...
-(NSDictionary*) getSingleMemoryContainerWhereDic:(NSDictionary*)whereDic;              //获取where的最近一条;(模糊匹配)
-(NSArray*) getMemoryContainerWhereDic:(NSDictionary*)whereDic limit:(NSInteger)limit;  //获取where的所有条;(模糊匹配)
