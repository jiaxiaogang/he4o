...
> 第三梯队:随着大数据,云计算等成熟,AI迎来DL热,但DL并非全功能型智能体,he4o旨在解决这一问题。
...
| --- |
| 螺旋论本质上是一个熵减机理论，其包含三大要素，分别为： 定义、相对和循环。 |
...
| 性能要求 | 可运行于单机终端 |
| 编程思想 | DOP (面向动态编程) |
| 架构设计 | 以螺旋论展开成信息熵减机模型,再由信息熵减机模型展开为系统架构 `碰巧与大脑多有相似之处^_^` |
...
> ##### 2020.03.31 `耗时1个月`
> - 迭代外类比: 新增反向反馈类比 (构建SP正负时序、应用SP于决策的MC中、迭代反思)
...
> ##### 2020.08.12 `耗时27天`
> - 反省迭代(DiffAnalogy)、生物钟(AITime)、PM理性评价迭代v2
