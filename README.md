...
1、此物甚大，当属予众，不可私执，执者必失。  
2、为保障第1条，此系统采用LGPL[![License](https://img.shields.io/badge/license-GPL-blue.svg)](LICENSE)开源协议。  
3、商业化可联系作者获取商业授权，但商业化只可以获取应用层等的闭源授权，与第2条冲突时，第2条优先。  
